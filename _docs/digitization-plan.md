...
Create faithful, readable HTML editions while preserving the scans, bibliography citations, and public PDF addresses. The project owner has reviewed and accepted the David Nieto pilot, its review record, and this editorial standard. The archive now contains forty-six transcriptions (two unreadable words are explicitly marked in Boloney): David Nieto is accepted, and forty-five works await their own editorial review. The latest owner-requested batch adds seven English and three Hebrew works; see [the ten-work review guide](batches/2026-09-10-ten-works.md). All forty-six remain unpublished and reading pages omit inline editorial page markers.
